...
\textbf{socio} o \textbf{chiamato}& colui che possiede la carta chiamata dal giaguaro \\
...
\textbf{strozzino} & quando si gioca un carichinno del seme della carta (non di briscola) che sta comandando il gioco (acquisendo diritto di presa) \\
